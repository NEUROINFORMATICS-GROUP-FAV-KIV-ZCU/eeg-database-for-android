...
/**
 * Custom class of ArrayAdapter. Used for viewing ElectrodeSystem records in ListView.
 *
 * @author Petr Miko
 */
public class ElectrodeSystemAdapter extends AbstractAdapter<ElectrodeSystem> {
    /**
     ...
     */
    public ElectrodeSystemAdapter(Context context, int resourceId, List<ElectrodeSystem> items) {
    ...
    protected View initView(int position, View convertView, ViewGroup parent) {
        ...
        ElectrodeSystem record = getItem(position);
        if (record != null) {
